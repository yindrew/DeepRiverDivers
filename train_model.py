...
class PokerDataset(Dataset):
    ...
    def __init__(self, hand_histories: List[Tuple[Dict, float]], max_seq_length: int = 20):
        """
    ...
    def __getitem__(self, idx: int) -> Tuple[Dict[str, torch.Tensor], torch.Tensor]:
        ...
        if actions.shape[0] < self.max_seq_length:
            ...
            padding = torch.zeros((self.max_seq_length - actions.shape[0], actions.shape[1]), dtype=actions.dtype)
